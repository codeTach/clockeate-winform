namespace Clockeate
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            timerTimeRefresher = new System.Windows.Forms.Timer(components);
            SuspendLayout();
            // 
            // clockin_button
            // 
            clockin_button.BackColor = Color.ForestGreen;
            clockin_button.Location = new Point(32, 99);
            ...
            clockout_button.Location = new Point(32, 173);
            ...
            // timerTimeRefresher
            // 
            timerTimeRefresher.Enabled = true;
            timerTimeRefresher.Tick += timer1_Tick;
            // 
            // Form1
            // 
        ...
        private System.Windows.Forms.Timer timerTimeRefresher;
    }
}
